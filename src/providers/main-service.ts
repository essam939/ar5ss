export class MainService {
  ...
  public static baseUrl : string = "https://api.ar5ss.com/public/api/";
  public static baseUrl2 : string = "http://www.zadalsharq.com/ar5ss/public/api/";

  
  public static ip : string = "https://api.ar5ss.com/";
